...
for consumption by external sites (aimaturitymodels.com's Whole-Model
View). No version bump — this is a derived rendering, not a change to
any dimension's maturity content, same category as
